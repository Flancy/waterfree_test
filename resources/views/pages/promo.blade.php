	...
	<div class="row">
		<div class="col-sm-12">
			...
			<p>
				...
				Чтобы получить промокод сервиса <a href="https://myhim.ru">MYHIM.RU</a>, спрашивайте у операторов автомобильных моек в Вашем городе. <br>
				<a href="{{ route('pages.contacts.index') }}"><strong>Список городов</strong></a>
			</p>
			<p>
				Чтобы использовать промокоды, необходимо <a href="{{ route('register') }}">зарегистрироваться</a> у нас на сервисе. <br>
